            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="active"><a href="accountant.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon glyphicon-user"></span><p>Accountant</p></a></li>
                                    ...
                                    <div class="panel-body">
                                        <div role="tabpanel">
                                            ...
                                            <ul class="nav nav-tabs" role="tablist">
                                                ...
                                                <li role="presentation" class="active"><a href="#tab5" role="tab" data-toggle="tab">Accountant</a></li>
                                                <li role="presentation"><a href="#tab6" role="tab" data-toggle="tab">Add Accountant</a></li>
                                                <li role="presentation"><a href="#tab7" role="tab" data-toggle="tab">Bulk Upload</a></li>										
                                          ...
                                          print '
										       <tr>
                                                ...
                                                <ul class="dropdown-menu" role="menu">
													<li><a href="edit-accountant.php?tid='.$row['teacher_id'].'">Edit Accountant</a></li>
													<li><a href="view-accountant.php?tid='.$row['teacher_id'].'">View Accountant</a></li>
                                                    <li><a'; ?> <?php print ' href="pages/drop-accountant.php?id='.$row['teacher_id'].'">Delete</a></li>
                                                </ul>
                                            </div></td>
                                        ...
                                        <em>No Accountants Found.</em>
                                         ...
                                         <form action="pages/add_accountant.php" method="POST">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="panel panel-info">
                                                                <div class="panel-heading">
                                                                    <h4><i class="fa fa-upload"></i> Upload Accountants</h4>
                                                                </div>
                                                                <div class="panel-body">
                                                                    <form action="pages/process_bulk_upload.php" method="POST" enctype="multipart/form-data">
                                                                        <input type="hidden" name="upload_type" value="accountants">
                                                                        <div class="form-group">
                                                                            <label>Upload CSV File</label>
                                                                            <input type="file" class="form-control" name="csv_file" accept=".csv" required>
                                                                            <small class="text-muted">Format: Accountant ID, First Name, Last Name, Gender, Email, Password</small>
                                                                        </div>
                                                                        <button type="submit" class="btn btn-primary">
                                                                            <i class="fa fa-upload"></i> Upload Accountants
                                                                        </button>
                                                                    </form>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="panel panel-default">
                                                                ...
                                                                <div class="panel-body">
                                                                    <p>Download the CSV template for accountants:</p>
                                                                    <a href="pages/download_template.php?type=accountants" class="btn btn-success">
