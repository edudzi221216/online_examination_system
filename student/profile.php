        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="active"><a href="profile.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-lock"></span><p>My Profile</p></a></li>
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3><td><b><?php echo "$myfname"; ?> <?php echo "$mylname"; ?></b></td>'s  profile</h3>
                      ...
                      <div class="row">
						...
						<div class="row">
                            <div class="col-md-5">
									...
									<table class="table">
                                        <tbody>
                                            ...
                                            <tr>
                                                <th scope="row">2.</th>
                                                <td>Name</td>
                                                <td><b><?php echo "$myfname $mylname"; ?></b></td>
                                                
                                            </tr>
                                            <tr>
                                                <th scope="row">3.</th>
                                                <td>Academic Year</td>
                                                <td><b><?php echo "$myay"; ?></b></td>
                                               
                                            </tr>
											<tr>
                                                <th scope="row">4.</th>
                                                <td>Class</td>
                                                <td><b><?php echo "$myclass"; ?></b></td>
                                ...
                                <input type="password" id="password" class="form-control" name="old-password" required placeholder="Enter new password">
                                </div>
								
								<div class="form-group">
                                <label for="exampleInputEmail1">Enter new password</label>
                                <input type="password" id="confirm_password" class="form-control" name="new-password" required placeholder="Confirm new password">
                                </div>
