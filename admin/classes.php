            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="active"><a href="classes.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon glyphicon-th-list"></span><p>Class</p></a></li>
                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
                                        ...
                                        <em>No Class Found.</em>
                                         ...
                                         <form action="pages/add_class.php" method="POST">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="panel panel-info">
                                                                <div class="panel-heading">
                                                                    <h4><i class="fa fa-upload"></i> Upload Classes</h4>
                                                                </div>
                                                                <div class="panel-body">
                                                                    <form action="pages/process_bulk_upload.php" method="POST" enctype="multipart/form-data">
                                                                        <input type="hidden" name="upload_type" value="classes">
                                                                        <div class="form-group">
                                                                            <label>Upload CSV File</label>
                                                                            <input type="file" class="form-control" name="csv_file" accept=".csv" required>
                                                                            <small class="text-muted">Format: Class ID, Class Name, Academic Year</small>
                                                                        </div>
                                                                        <button type="submit" class="btn btn-primary">
                                                                            <i class="fa fa-upload"></i> Upload Classes
                                                                        </button>
                                                                    </form>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="panel panel-default">
                                                                ...
                                                                <div class="panel-body">
                                                                    <p>Download the CSV template for classes:</p>
                                                                    <a href="pages/download_template.php?type=classes" class="btn btn-success">
