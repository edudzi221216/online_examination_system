            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="active"><a href="notice.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-comment"></span><p>Notice</p></a></li>
                                    ...
                                    <div class="panel-body">
                                        <div role="tabpanel">
                                            ...
                                            <ul class="nav nav-tabs" role="tablist">
                                                ...
                                                <li role="presentation" class="active"><a href="#tab5" role="tab" data-toggle="tab">Issued Notices</a></li>
                                        ...
                                        <tbody>';
                                          ...
                                          print '
										       <tr>
                                                ...
                                                <a onclick="return confirm(\'Are You Sure You Want To Delete the Notice?\')" href="pages/drop_notice.php?id='.$row['notice'].'" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Delete</a></td>
										...
										<div class="form-group">
                                            ...
                                            <textarea style="resize: both; overflow :auto;" rows="4"  class="form-control" placeholder="Type your Notice" name="notice" required autocomplete="off"></textarea>
                                        </div>
