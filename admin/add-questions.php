...
// Check if current user can add questions to this exam
$can_add_questions = false;

if ($_SESSION['role'] === 'admin') {
    // Admin can only add questions to exams they created
    $can_add_questions = ($created_by_type === 'admin');
} elseif ($_SESSION['role'] === 'teacher') {
    // Teachers can only add questions to exams they created
    $can_add_questions = ($created_by_type === 'teacher' && $created_by === $_SESSION['myid']);
}

// If user cannot add questions, redirect them
if (!$can_add_questions) {
    $_SESSION['error'] = "You don't have permission to add questions to this exam. Only the creator can modify it.";
                                    ...
                                    <div class="panel-body">
                                        <div role="tabpanel">
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <textarea style="resize: both; overflow :auto;" rows="6" class="form-control" placeholder="Enter question" name="question" required autocomplete="off"></textarea>
                                                <script>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" style="border: 2px solid #f25656;" class="form-control" placeholder="Enter marks for the above question" name="qmarks" required autocomplete="off">
                                                </div>
                                      ...
                                      <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                               ...
                                               <textarea style="resize: both; overflow :auto;" rows="2" class="form-control" placeholder="Enter option 1" name="opt1" required autocomplete="off"></textarea> <!--Resize text box-->
                                            ...
                                            <tr>
                                                ...
                                                <label for="exampleInputEmail1">Option 2</label>
                                                 ...
                                                 <textarea style="resize: both; overflow :auto;" rows="2" class="form-control" placeholder="Enter option 2" name="opt2" required autocomplete="off"></textarea> <!--Resize text box-->
                                            ...
                                            <tr>
                                                ...
                                                <label for="exampleInputEmail1">Option 3</label>
                                                 ...
                                                 <textarea style="resize: both; overflow :auto;" rows="2" class="form-control" placeholder="Enter option 3" name="opt3" required autocomplete="off"></textarea> <!--Resize text box-->
											...
											<tr>
                                                ...
                                                <textarea style="resize: both; overflow :auto;" rows="2" class="form-control" placeholder="Enter option 4" name="opt4" required autocomplete="off"></textarea> <!--Resize text box-->
                                                
                                                </div>
												</td>
                                                <td><input type="radio" -webkit-transform: scale(1.5); transform: scale(1.5);  name="answer" value="option4" required></td>
