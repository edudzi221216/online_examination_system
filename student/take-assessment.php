...
include '../includes/enhanced_exam_scheduler.php';
...
if ($result->num_rows > 0) {
	...
	if (!$availability['available']) {
		header("location:./?error=exam_not_available&message=" . urlencode($availability['message']));
		exit();
	}
								...
								print '
                                 <div class="alert alert-success" role="alert">
                                  Your Exam is Submitted.
									...
									'; /*?>
									<a onclick="return confirm('Are you sure you want to begin?')" class="btn btn-success btn-sm" href="assessment.php"><i class="fa fa-refresh"></i> Retake Assessment</a>
                               ...
                               /* print '
								...
								print '
                                 <div class="alert alert-success" role="alert">You are ready to start for your exam.
									...
									'; ?>
									<a onclick="return confirm('Are you sure you want to begin?')" class="btn btn-success btn-lg" href="assessment.php"><i class="fa fa-play"></i> <b>Start Examination</b></a>
