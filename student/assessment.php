...
if ($result->num_rows > 0) {
    ...
    $sql = "INSERT INTO tbl_assessment_records (record_id, student_id, student_name, class, exam_name, exam_id, subject ,score, status, next_retake, date, fstatus)
VALUES ('$recid', '$myid', '$myname','$myclass', '$exam_name', '$exam_id','$subject', '0', 'FAIL', '$next_retake', '$today_date', '$myfees')";   // default values
...
<head>
    ...
    <link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
        <link href="assets/css/button-styles.css" rel="stylesheet" type="text/css"/> <!--Internet requires-->
                        ...
                        <div class="panel-body">
                            ...
                            <div class="tabs-below" role="tabpanel">
                                <div class="tab-content">
                                    <h1 style="text-align:center;"><b>Online Exam </b></h1>
                            ...
                            <br><button onclick="return confirm('Are you sure you want to Submit your Exam?')" class="btn btn-success btn-lg" type="submit"><i class="fa fa-check"></i> Submit Exam</button>
    ...
    <script type="text/javascript">
        ...
        function CheckTime() {
            ...
            if (total_seconds <= 0) {
                ...
                alert("Exam duration is due. Your Exam has been Submitted.");
