            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="active"><a href="results.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-credit-card"></span><p>Exam Results</p></a></li>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
										   ...
										   $sql = "SELECT * FROM tbl_assessment_records WHERE student_id = '$myid' AND rstatus = 'Result Published' AND fstatus = 'Paid'";
                                        ...
                                        <em> Results is not published yet. </em>
                                    </div>';
