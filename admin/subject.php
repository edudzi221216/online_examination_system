                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="panel panel-info">
                                                                <div class="panel-heading">
                                                                    <h4><i class="fa fa-upload"></i> Upload Subjects</h4>
                                                                </div>
                                                                <div class="panel-body">
                                                                    <form action="pages/process_bulk_upload.php" method="POST" enctype="multipart/form-data">
                                                                        <input type="hidden" name="upload_type" value="subjects">
                                                                        <div class="form-group">
                                                                            <label>Upload CSV File</label>
                                                                            <input type="file" class="form-control" name="csv_file" accept=".csv" required>
                                                                            <small class="text-muted">Format: Subject ID, Subject Name, Class</small>
                                                                        </div>
                                                                        <button type="submit" class="btn btn-primary">
                                                                            <i class="fa fa-upload"></i> Upload Subjects
                                                                        </button>
                                                                    </form>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="panel panel-default">
                                                                ...
                                                                <div class="panel-body">
                                                                    <p>Download the CSV template for subjects:</p>
                                                                    <a href="pages/download_template.php?type=subjects" class="btn btn-success">
