<?php include 'includes/check_user.php';    // check admin informarion and holds the data
include 'includes/fetch_records.php';  // it will counts the info from database
?>
<!DOCTYPE html>
<html>
    ...
    <body class="page-header-fixed">
        ...
        <main class="page-content content-wrap">
            <div class="navbar">
                ...
                <div class="sidebar-pusher">   <!--side menu for mobile,tablet devices-->
                            ...
                            <div class="panel info-box panel-white">
                                <div class="panel-body">
                                    <div class="info-box-stats">
                                        <p class="counter"><?php echo number_format($acad); ?></p>   -->
                                                                <!-- // number_format: it will round the value -->
                                       <!-- <span class="info-box-title">ACADEMIC YEAR</span>
                                    </div>
