            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="active"><a href="teacher.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon glyphicon-user"></span><p>Teachers</p></a></li>
                                          ...
                                          print '
										       <tr>
                                                ...
                                                <ul class="dropdown-menu" role="menu">
													<li><a href="edit-teacher.php?tid='.$row['teacher_id'].'">Edit Teacher</a></li>
													<li><a href="view-teacher.php?tid='.$row['teacher_id'].'">View Teacher</a></li>
                                                    <li><a'; ?> <?php print ' href="pages/drop_teacher.php?id='.$row['teacher_id'].'">Delete</a></li>
                                                </ul>
                                            </div></td>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="panel panel-info">
                                                                <div class="panel-heading">
                                                                    <h4><i class="fa fa-upload"></i> Upload Teachers</h4>
                                                                </div>
                                                                <div class="panel-body">
                                                                    <form action="pages/process_bulk_upload.php" method="POST" enctype="multipart/form-data">
                                                                        <input type="hidden" name="upload_type" value="teachers">
                                                                        <div class="form-group">
                                                                            <label>Upload CSV File</label>
                                                                            <input type="file" class="form-control" name="csv_file" accept=".csv" required>
                                                                            <small class="text-muted">Format: Teacher ID, First Name, Last Name, Gender, Email, Password</small>
                                                                        </div>
                                                                        <button type="submit" class="btn btn-primary">
                                                                            <i class="fa fa-upload"></i> Upload Teachers
                                                                        </button>
                                                                    </form>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="panel panel-default">
                                                                ...
                                                                <div class="panel-body">
                                                                    <p>Download the CSV template for teachers:</p>
                                                                    <a href="pages/download_template.php?type=teachers" class="btn btn-success">
