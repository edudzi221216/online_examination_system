                                    ...
                                    <div class="panel-body">
                                        ...
                                        <tbody>';
                                          ...
                                          print '
                                            ...
                                            <td><a onclick="return confirm(\'Reactivate exam for <?php echo $row[\'student_name\']; ?>?\')" href="pages/re-activate.php?rid='.$row['record_id'].'&eid='.$exam_id.'" class="btn btn-success btn-sm"><i class="fa fa-refresh"></i> Re-Exam</a></td> 
