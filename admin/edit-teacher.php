        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3>Edit Teacher - <?php echo "$tdfname"; ?> <?php echo "$tdlname"; ?></h3>
                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="<?php echo "$teacher_id"; ?>" class="form-control" placeholder="Enter last name" name="password" required autocomplete="off">
                                        </div>
