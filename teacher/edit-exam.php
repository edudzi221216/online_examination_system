            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="active"><a href="classexamination.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-list-alt"></span><p>Examinations</p></a></li>
						...
						<div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="panel panel-white">
                                    ...
                                    <input type="text" class="form-control date-picker" value="<?php echo"$exdate"; ?>" name="date" required autocomplete="off" placeholder="Select Start Exam Date">
                                    </div>
									<div class="form-group">
                                    <label >End Exam Date</label>
                                    <input type="text" class="form-control date-picker" value="<?php echo"$exend_exam_date"; ?>" name="end_exam_date" required autocomplete="off" placeholder="Select End Exam Date">
                                    </div>
									<div class="form-group">
                                    <label >Start Time</label>
                                    <input type="time" class="form-control" value="<?php echo"$exstart_time"; ?>" name="start_time" required autocomplete="off" placeholder="Select Start Time" step="1">
                                    </div>
									<div class="form-group">
                                    <label >End Time</label>
                                    <input type="time" class="form-control" value="<?php echo"$exend_time"; ?>" name="end_time" required autocomplete="off" placeholder="Select End Time" step="1">
                                    </div>
										<div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control date-picker" id="resultPublishStartDate" name="result_publish_start_date" value="<?php echo $result_publish_start_date; ?>" autocomplete="off" placeholder="Select Start Date">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="resultPublishStartTime">Result Publication Start Time</label>
                                                            <input type="time" class="form-control" id="resultPublishStartTime" name="result_publish_start_time" value="<?php echo $result_publish_start_time; ?>" autocomplete="off" placeholder="Select Start Time" step="1">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="resultPublishEndDate">Result Publication End Date</label>
                                                            <input type="text" class="form-control date-picker" id="resultPublishEndDate" name="result_publish_end_date" value="<?php echo $result_publish_end_date; ?>" autocomplete="off" placeholder="Select End Date">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="resultPublishEndTime">Result Publication End Time</label>
                                                            <input type="time" class="form-control" id="resultPublishEndTime" name="result_publish_end_time" value="<?php echo $result_publish_end_time; ?>" autocomplete="off" placeholder="Select End Time" step="1">
                                                        </div>
                                                    </div>
                                                </div>
