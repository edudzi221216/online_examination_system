            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="active"><a href="acad.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-tasks"></span><p>Academic Year</p></a></li>
                                    ...
                                    <div class="panel-body">
                                        <div role="tabpanel">
                                            ...
                                            <ul class="nav nav-tabs" role="tablist">
                                                <li role="presentation" class="active"><a href="#tab5" role="tab" data-toggle="tab">Acad. Year</a></li>
                                                <li role="presentation"><a href="#tab6" role="tab" data-toggle="tab"> + Acad. Year</a></li>
                                            </ul>
                                        ...
                                        <em>No Academic Years Found.</em>
                                         ...
                                         <form action="pages/add_ay.php" method="POST">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Academic Year</label>
                                            <input type="text" class="form-control" placeholder="Enter New Academic Year" name="ay" required autocomplete="off">
                                        </div>
