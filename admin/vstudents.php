        ...
        <div class="page-sidebar sidebar">
            <div class="page-sidebar-inner slimscroll">
                ...
                <ul class="menu accordion-menu">
                    ...
                    <li><a href="classexamination.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-list-alt"></span>
                            <p>Examinations</p>
                        </a></li>
                                    ...
                                    <div class="panel-body">
                                        <div role="tabpanel">
                                            ...
                                            <ul class="nav nav-tabs" role="tablist">
                                                ...
                                                <li role="presentation"><a href="#tab7" role="tab" data-toggle="tab">Upload Student</a></li>
                                        ...
                                        <tbody>';
										       ...
										       <tr>
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    ...
                                                    <li><a'; ?> <?php print ' href="pages/drop_sd.php?id=' . $row['user_id'] . '">Delete</a></li>
                                                </ul>
                    
                                            </div></td>
                                                <td style="color:red";>' . $row['last_login'] . '</td>
                                                <td>' . $row['login_device'] . '</td>
                                        ...
                                        <em> No Students Found. </em>
                                                ...
                                                <div role="tabpanel" class="tab-pane fade" id="tab7">
                                                    <form action="pages/add_student_csv.php" method="POST"  enctype="multipart/form-data">
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1">Select Academic Year</label>
                                                            <select class="form-control" name="ay" required>
                                                                <option value="" selected disabled>-- Select A.Y. -</option>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <small class="form-text text-muted">CSV format: First Name, Last Name, Gender, Email, Contact Number</small>
                                                        </div>
